...
<template>
    <main class="container py-4">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="text-end flex-shrink-0">
                <p class="mb-1 text-nowrap">
                    ...
                    question{{ training.questions.length > 1 ? "s" : "" }}</p>
            </div>
        ...
        <form @submit.prevent>
            <div v-for="q, i in training.questions" :key="q.id"
                ...
                <div>
                    ...
                    <textarea v-if="q.type === 'textarea'" :id="q.id" v-model="answers[q.id] as string"
                ...
                <div>
                    ...
                    <select class="form-select" id="questionType" v-model="q.type"
